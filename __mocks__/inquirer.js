...
exports.prompt = (prompts) => {
	...
	prompts.forEach((prompt, index) => {
		...
		const choices = typeof prompt.choices === 'function' ? prompt.choices(answers) : prompt.choices
		if (a.choices) {
		...
		if (a.useDefault) {
			...
			setValue(typeof prompt.default === 'function' ? prompt.default(answers) : prompt.default)
		}
	})
