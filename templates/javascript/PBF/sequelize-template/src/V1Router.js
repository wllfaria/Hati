...
const ServerStatusController = require('./v1/UseCases/ServerStatus/ServerStatusController')
const ExampleController = require('./v1/UseCases/Example/ExampleController')
...
class V1Router {
	...
	routesList = [
		 ...
		 */
		{ path: '/status', handler: this.statusController.handle, method: 'GET' },
		{ path: '/example', handler: this.exampleController.handle, method: 'GET' }
	]
