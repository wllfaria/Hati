...
import { ServerStatusController } from './v1/UseCases/ServerStatus/ServerStatusController'

export class V1Router extends Router {
	private v1Router: core.Router = express.Router()

	private statusController: Controller = new ServerStatusController()

	public readonly routesList: TApiRoute[] = [
		{ path: '/status', handler: this.statusController.handle, method: EHttpAllowedMethods.GET }
	]
